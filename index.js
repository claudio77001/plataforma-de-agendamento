...
var numeroLido = parseInt(prompt("Digite um número inteiro:"));
var resultado = verificarNumero(numeroLido);
console.log("O n\u00FAmero ".concat(numeroLido, " \u00E9 ").concat(resultado, "."));
